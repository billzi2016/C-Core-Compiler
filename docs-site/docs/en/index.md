...
This site contains the project documentation for `C-Core-Compiler`.
...
- [Compiler Overview](project/compiler-overview.md)
- [Lexer and Tokens](project/lexer-and-tokens.md)
- [Parser and AST](project/parser-and-ast.md)
- [Semantic Analysis](project/semantic-analysis.md)
- [IR and Lowering](project/ir-and-lowering.md)
